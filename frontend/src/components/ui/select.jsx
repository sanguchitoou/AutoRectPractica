...
function SelectTrigger({
  ...
  const sizeStyles = {
    default: { height: "32px", paddingTop: "8px", paddingBottom: "8px" },
    sm: { height: "28px", paddingTop: "6px", paddingBottom: "6px" },
    lg: { height: "44px", paddingTop: "10px", paddingBottom: "10px" },
  };

  const mergedStyle = { ...sizeStyles[size] || sizeStyles.default, ...style };
