...
function SidebarProvider({
  ...
  const setOpen = React.useCallback((value) => {
    ...
    // Esto guarda la cookie para mantener el estado de la barra lateral.
    document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`
  }, [setOpenProp, open])

  // Función auxiliar para alternar la barra lateral.
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpenMobile((open) => !open) : setOpen((open) => !open);
  }, [isMobile, setOpen, setOpenMobile])

  // Agrega un atajo de teclado para alternar la barra lateral.
  React.useEffect(() => {
  ...
  // Agregamos un estado para usar data-state="expanded" o "collapsed".
    ...
    <div
      ...
      <div
        ...
        className={cn(
          ...
          // Ajusta el padding para las variantes flotante e inset.
          variant === "floating" || variant === "inset"
